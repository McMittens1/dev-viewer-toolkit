...
Five defects found in an independent review, each now covered by a regression test. A second review found four gaps in those fixes, and a follow-up check found one more in the mobile-home lookup. All of them are corrected and marked *Corrected after review* below. None of this changes a result on good data.
