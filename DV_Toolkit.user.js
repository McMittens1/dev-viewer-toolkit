...
// @version      1.7.0
// @description  Auto-applies the redesigned parcel popup (v8) and the Quick Bar (v3.7, with the #INVALID repair extended to 19 rows, shareable deep links, parcel results in the search box, and the Inspector-rows fix) to the public Development Viewer. Replaces the console paste and the once-per-page-load bookmark click.
...
(function () {
  ...
  /* ---------------------------------------------------------------------
   * Development Viewer Toolkit 1.7.0 -- auto-run wrapper.
   *
  ...
  window.__dvToolkit = { version: '1.7.0', ready: false };
