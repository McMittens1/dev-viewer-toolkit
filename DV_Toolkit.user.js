...
// @version      1.7.1
// @description  Auto-applies the redesigned parcel popup (v8) and the Quick Bar (v3.8) to the public Development Viewer: FEMA Zone A now recognised alongside Zone AE, floodplain share of parcel, the #INVALID repair extended to 20 rows, shareable deep links, parcel results in the search box, and the Inspector-rows fix. Replaces the console paste and the once-per-page-load bookmark click.
...
(function () {
  ...
  /* ---------------------------------------------------------------------
   * Development Viewer Toolkit 1.7.1 -- auto-run wrapper.
   *
  ...
  window.__dvToolkit = { version: '1.7.1', ready: false };
